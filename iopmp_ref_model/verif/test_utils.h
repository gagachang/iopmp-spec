...
extern void configure_srcmd_n(iopmp_t *iopmp, uint8_t srcmd_reg, uint16_t srcmd_idx, reg_intf_dw data, uint8_t num_bytes);
extern void configure_mdcfg_n(iopmp_t *iopmp, uint8_t md_idx, reg_intf_dw data, uint8_t num_bytes);
extern void configure_entry_n(iopmp_t *iopmp, uint8_t entry_reg, uint64_t entry_idx, reg_intf_dw data, uint8_t num_bytes);
...
extern int error_record_chk(iopmp_t *iopmp, uint8_t err_type, uint8_t perm, uint64_t addr, bool err_rcd);
extern void set_hwcfg0_enable(iopmp_t *iopmp);
